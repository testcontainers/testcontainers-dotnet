namespace DotNet.Testcontainers.Tests.Fixtures
{
  ...
  public sealed class IgnoreFileFixture : TheoryData<IgnoreFile, string, bool>
  {
    public IgnoreFileFixture()
    {
      ...
      Add(ignoreFilesAndDirectories, "binary/Debug", true);
      ...
      Add(ignoreBuiltInDirectories, "src/.ideality/file.json", true);
      Add(ignoreBuiltInDirectories, "src/.vs/file.json", false);
      Add(ignoreBuiltInDirectories, "src/.vsual/file.json", true);
