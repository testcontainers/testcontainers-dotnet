...
public sealed class Neo4jBuilderTest
{
    ...
    [InlineData(
        "neo4j@sha256:20eb19e3d60f9f07c12c89eac8d8722e393be7e45c6d7e56004a2c493b8e2032",
        null
    )]
    public void AppendsEnterpriseSuffixWhenEnterpriseEditionLicenseAgreementIsAccepted(
        string image,
        string expected
    )
    {
    ...
    public void ThrowsArgumentExceptionWhenEnterpriseEditionLicenseAgreementIsNotAccepted(
        Neo4jBuilder neo4jBuilder
    )
    {
