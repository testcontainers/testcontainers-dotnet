...
public abstract class AzuriteContainerAzureSasCredentialsHttpsPemTest : IAsyncLifetime
{
    ...
    public sealed class BlobService : AzuriteContainerAzureSasCredentialsHttpsPemTest
    {
        [Fact]
    ...
    public sealed class QueueService : AzuriteContainerAzureSasCredentialsHttpsPemTest
    {
        [Fact]
        [Trait(nameof(DockerCli.DockerPlatform), nameof(DockerCli.DockerPlatform.Linux))]
        public async Task EstablishesConnection()
    ...
    public sealed class TableService : AzuriteContainerAzureSasCredentialsHttpsPemTest
    {
        [Fact]
        [Trait(nameof(DockerCli.DockerPlatform), nameof(DockerCli.DockerPlatform.Linux))]
        public async Task EstablishesConnection()
