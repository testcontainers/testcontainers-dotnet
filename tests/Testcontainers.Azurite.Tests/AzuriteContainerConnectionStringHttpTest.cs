...
public abstract class AzuriteContainerConnectionStringHttpTest : IAsyncLifetime
{
    ...
    public sealed class BlobService : AzuriteContainerConnectionStringHttpTest
    {
        [Fact]
    ...
    public sealed class QueueService : AzuriteContainerConnectionStringHttpTest
    {
        [Fact]
        [Trait(nameof(DockerCli.DockerPlatform), nameof(DockerCli.DockerPlatform.Linux))]
        public async Task EstablishesConnection()
    ...
    public sealed class TableService : AzuriteContainerConnectionStringHttpTest
    {
        [Fact]
        [Trait(nameof(DockerCli.DockerPlatform), nameof(DockerCli.DockerPlatform.Linux))]
        public async Task EstablishesConnection()
