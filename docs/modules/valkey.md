...
The Testcontainers Redis module is compatible with the Valkey container image. You can use the existing [`Testcontainers.Redis`](/modules/redis/) package without requiring a separate Valkey module.
