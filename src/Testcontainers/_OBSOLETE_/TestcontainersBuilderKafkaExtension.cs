namespace DotNet.Testcontainers.Builders
{
  ...
  {
    public static ContainerBuilder<KafkaTestcontainer> WithKafka(this ContainerBuilder<KafkaTestcontainer> builder, KafkaTestcontainerConfiguration configuration)
    {
