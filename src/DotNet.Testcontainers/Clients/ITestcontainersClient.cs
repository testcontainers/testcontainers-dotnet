namespace DotNet.Testcontainers.Clients
{
  ...
  internal interface ITestcontainersClient
  {
    ...
    /// <summary>
    /// Gets inspection information for a Testcontainer.
    /// </summary>
    /// <param name="id">Docker container id.</param>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>Task with <see cref="ContainerInspectResponse"/>.</returns>
    ...
    Task<ContainerInspectResponse> Inspect(string id, CancellationToken ct = default);
